const client_id = "b6fe9100-ed3c-11ec-a3fd-a19b9cb895a3";
const client_email = "hammad@xorexs.com";
sessionStorage.setItem("client_id", client_id);
sessionStorage.setItem("client_email", client_email);
const API_URL =
  "https://faceki.com/backend/api/sdk-settings?client_id=" + client_id;
const pathUrl = window.location.pathname;
const baseUrl = window.location.origin + "/";

document.getElementById("kyc_items").innerHTML =
  '<img src="face/img/icon/loader.gif">';
...
fetch(API_URL)
  ...
  .then(function (res) {
    ...
    if (
      ...
      success_redirect_url.indexOf("http://") == -1 &&
      success_redirect_url.indexOf("https://") == -1
    ) {
    ...
    if (
      ...
      declined_redirect_url.indexOf("http://") == -1 &&
      declined_redirect_url.indexOf("https://") == -1
    ) {
    ...
    if (
      invalid_redirect_url != null &&
      invalid_redirect_url.indexOf("http://") == -1 &&
      invalid_redirect_url.indexOf("https://") == -1
    ) {
...
function set_sdk_html() {
  ...
  sessionStorage.setItem(
    "doc_three_front_icon",
    "white_" + doc_three_front_icon
  );
  ...
  if (number_of_doc == 1) {
    kyc_items =
      kyc_items +
      `<li class="faceki-card__item">
                                    <span class="faceki-card__number">` +
      item_number +
      `</span>
                                   <div class="id-card-logo"><img class="faceki-card__img" src="face/img/user-info/` +
      doc_one_front_icon +
      `" alt=""></div>
                                    <span>Scan ` +
      doc_type_one +
  ...
  kyc_items =
    ...
    item_number +
    `</span>
                                    <div class="id-card-logo"><img class="faceki-card__img" src="face/img/user-info/user.png" alt=""></div>
