...
(function () {
  ...
  document.querySelector(".faceki-card__img").src =
    "face/img/user-info/" + doc_one_front_icon;
  var doc_type_one = sessionStorage.getItem("doc_type_one");
  document.querySelector(".faceki-card__title").textContent =
    "Scan your " + doc_type_one;
  ...
  confirm.addEventListener(
    ...
    function (ev) {
      ...
      if (front_img == "" || front_img == null) {
        ...
        document.querySelector(".faceki-card__img").src =
          "face/img/user-info/" + doc_one_back_icon;
        //document.querySelector('.faceki-card__img').src = 'face/img/user-info/id-back-light.png';
        document.querySelector(".title").textContent = "BACK SIDE";
      } else if (front_img_two == "" || front_img_two == null) {
        //alert(3);
        var doc_two_front_icon = sessionStorage.getItem("doc_two_front_icon");
        document.querySelector(".faceki-card__img").src =
          "face/img/user-info/" + doc_two_front_icon;
        //document.querySelector('.faceki-card__img').src = 'face/img/user-info/id-front-light.png';
        document.querySelector(".faceki-card__title").textContent =
          "Scan your " + doc_type_two;
        document.querySelector(".title").textContent = "FRONT SIDE";
      } else if (back_img_two == "" || back_img_two == null) {
        //alert(4);
        var doc_two_back_icon = sessionStorage.getItem("doc_two_back_icon");
        document.querySelector(".faceki-card__img").src =
          "face/img/user-info/" + doc_two_back_icon;
        //document.querySelector('.faceki-card__img').src = 'face/img/user-info/id-back-light.png';
        document.querySelector(".title").textContent = "BACK SIDE";
      } else if (front_img_three == "" || front_img_three == null) {
        //alert(5);
        var doc_three_front_icon = sessionStorage.getItem(
          "doc_three_front_icon"
        );
        document.querySelector(".faceki-card__img").src =
          "face/img/user-info/" + doc_three_front_icon;
        //document.querySelector('.faceki-card__img').src = 'face/img/user-info/id-front-light.png';
        document.querySelector(".faceki-card__title").textContent =
          "Scan your " + doc_type_three;
        document.querySelector(".title").textContent = "FRONT SIDE";
      } else {
        //alert(6);
        var doc_three_back_icon = sessionStorage.getItem("doc_three_back_icon");
        document.querySelector(".faceki-card__img").src =
          "face/img/user-info/" + doc_three_back_icon;
        //document.querySelector('.faceki-card__img').src = 'face/img/user-info/id-back-light.png';
        document.querySelector(".title").textContent = "BACK SIDE";
      }
