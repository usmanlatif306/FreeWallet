        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h4>Regular User</h4>                    
                    <div class="demo-img"><a href="{{route('demouser', app()->getLocale())}}" target="_blank" ><img alt="" src="{{asset('assets/images/thumb1.jpg')}}" class="img-responsive"></a></div>
                    <div class="demo-links">
                        <a href="{{route('demouser', app()->getLocale())}}" target="_blank" class="btn btn-fill btn-large btn-margin-right">Demo</a>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h4>Admin User</h4>                    
                    <div class="demo-img"><a href="https://admin.dxtrader.xyz/en/demo/admin" target="_blank" ><img alt=""  src="{{asset('assets/images/thumb2.jpg')}}" class="img-responsive"></a></div>
                    <div class="demo-links">
