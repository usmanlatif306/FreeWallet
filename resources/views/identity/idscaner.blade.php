...
<head>
    ...
    <title>Identification - {{ setting('site.site_name') }}</title>
    <!--  all css files  -->
    <link rel="stylesheet" href="{{ asset('face/css/bootstrap.min.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-lg-6 col-xl-5 mx-auto">
                    ...
                    <form id="successfullForm" action="{{route('identification_with_camera',app()->getLocale())}}"
                        method="post">
                        {{csrf_field()}}
                    </form>
                </div>
    ...
    <script src="{{ asset('face/js/kyc.js') }}"></script>
