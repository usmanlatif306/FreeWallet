  ...
  <div class="col-md-9 " style="padding-right: 0" id="#sendMoney">
    ...
    <div class="card">
      ...
      <div class="body">
        ...
        @endif
        <form action="{{route('requestMoney', app()->getLocale())}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
          <div class="row">
          ...
          <div class="row">
            <div class="col">
              <input type="submit" class="btn btn-primary float-right" value="{{__('Request Money')}}" {{auth()->user()->identified ? '' : 'disabled'}}>
            </div>
          </div>
          <div class="clearfix"></div>
        </form>
