...
@section('page_header')
    <h1 class="page-title">
        ...
        <a href="{{ route('wallet.transaction.edit', $dataTypeContent->getKey()) }}" class="btn btn-info">
        ...
        <a href="{{ route('wallet.transaction.index') }}" class="btn btn-warning">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('wallet.transaction.destroy',$dataType->id) }}" id="delete_form" method="POST">
                        {{ method_field("DELETE") }}
                        {{ csrf_field() }}
