...
<body id="top">
        ...
        <section class="navigation">
            <header>
                <div class="header-content">
                    <div class="logo"><a href="{{url('/')}}"><img src="{{setting('site.welcome_page_logo_url')}}" width="20%" alt="infinio logo"></a></div>
                    <div class="header-nav">
                        <nav>
                            ...
                            <ul class="member-actions">
                                @if (Auth::check())
                                <li><a href="{{ route('logout', app()->getLocale()) }}" class="login" onclick="event.preventDefault();
                                ...
                                <li><a href="{{ url('/admin/dashboard') }} " class="login">{{('Admin')}}</a></li>
                                @endif
                                <li><a href="{{ url( app()->getLocale(),'home') }} " class="btn-white btn-small">{{('My')}} {{ setting('site.site_name') }}</a></li>

                                @else
                                <li><a href="{{ url( app()->getLocale(), 'register') }}" class="login">{{__('Register')}}</a></li>
                                <li><a href="{{ url( app()->getLocale(), 'login') }}" class="btn-white btn-small">{{__('Log in')}}</a></li>
                                @endif
                            </ul>
                            @endif
                        </nav>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="hero-content text-center">
                        <h1>{{setting('site.site_name')}}, the smart choice for your business.</h1>
                        ...
                        @if (Auth::check())
                        <a href="{{url('/')}}/{{app()->getLocale()}}/home" class="btn btn-fill btn-large btn-margin-right">dashboard</a>
                        @else
                        <a href="{{url('/')}}/{{app()->getLocale()}}/login" class="btn btn-large btn-margin-right">Get Started</a>
                        @endif
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-4 intro-feature">
                    ...
                    <div class="intro-content last">
                        ...
                        <p>Payments you receive go to your {{setting('site.site_name')}} Balance in moments, and you can withdraw funds to your bank account.</p>
                    </div>
                </div>
                <div class="col-md-4 intro-feature">
                    <div class="intro-icon">
            ...
            <div class="row">
                <div class="col-md-5 col-md-offset-7">
                    <div class="feature-list">
                        <h3>{{setting('site.site_name')}} will drive your product forward</h3>
                        ...
                        <ul class="features-stack">
                            <li class="feature-item">
                                ...
                                <div class="feature-content">
                                    ...
                                    <p>{{setting('site.site_name')}} is universal and will look smashing on any device.</p>
                                </div>
                            </li>
                            <li class="feature-item">
                                <div class="feature-icon">
                                ...
                                <div class="feature-content">
                                    <h5>User Design</h5>
                                    <p>{{setting('site.site_name')}} takes advantage of common design patterns, allowing for a seamless experience for users of all levels.</p>
                                </div>
                            </li>
                            <li class="feature-item">
                                <div class="feature-icon">
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="footer-links">
                        ...
                        <p>Copyright © 2018 <a href="#">{{setting('site.site_name')}}</a></p>
                    </div>
                </div>
                <div class="social-share">
                    <p>Share {{setting('site.site_name')}} with your friends</p>
    ...
    <script>
        window.jQuery || document.write('<script src="{{asset('
            landing / js / vendor / jquery - 1.11 .2.min.js ')}}"><\/script>')
    </script>
