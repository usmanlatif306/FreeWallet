...
<?php elseif($transaction->activity_title == 'Coin Sent'): ?>

<?php echo e($transaction->activity_title); ?> <br><a href="#"><?php echo e(__('To')); ?> <?php echo e($transaction->type === 'self' ? $transaction->entity_name : $transaction->wallet_address); ?></a>
...
<?php elseif($transaction->activity_title == 'Coin Received'): ?>
...
<?php echo e($transaction->activity_title); ?> <br><a href="#"><?php echo e(__('On')); ?> <?php echo e($transaction->entity_name); ?> </a>
