             ...
             <ul class="header-dropdown">
                 ...
                 <li class=" dropdown"> <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown"
                     ...
                     <ul class="dropdown-menu dropdown-menu-right slideUp float-right">
                         ...
                         <li>
                             <a
                                 href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/deposit/<?php echo e(Auth::user()->currentWallet()->id); ?>"><?php echo e(__('DEPOSIT')); ?></a>
                             <hr style="margin: 0;">
                         </li>

                         <li>
                             <a
                                 href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/payout/<?php echo e(Auth::user()->currentWallet()->id); ?>"><?php echo e(__('WITHDRAW')); ?></a>
                             <hr style="margin: 0;">
                         </li>
         ...
         <div class="body" style="padding-top: 0">
             <div class="content d-flex justify-content-between align-items-center">
                 ...
                 <div class="number " style="color: white !important">
                     <?php echo e(\App\Helpers\Money::instance()->value($balance, Auth::user()->currentCurrency()->symbol)); ?>

                 </div>
                 <?php if(auth()->user()->currentWallet()->is_crypto): ?>
             ...
             <?php $__currentLoopData = $myEscrows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $escrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <div class="card">
                     ...
                     <div class="body">
                         ...
                         Escrow money to <a
                             href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/escrow/<?php echo e($escrow->id); ?>"><span
                                 class="text-primary"><?php echo e($escrow->toUser->name); ?></span></a> <br>
             ...
             <?php $__currentLoopData = $toEscrows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $escrow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <div class="card">
                     ...
                     <div class="body">
                         ...
                         Escrow money from <a
                             href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/escrow/<?php echo e($escrow->id); ?>"><span
                                 class="text-primary"><?php echo e($escrow->User->name); ?></span></a>
                     ...
                     <a href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/wallet/<?php echo e($someWallet->id); ?>">
                         <div class="card info-box-2" style="cursor: pointer;min-height: auto;">
                             ...
                             <div class="body" style="padding-top: 0;padding-bottom: 0;">
                                 <div class="content">
                                     <div class="number">
                                         <?php echo e(\App\Helpers\Money::instance()->value($someWallet->amount, $someWallet->currency->symbol)); ?>
         ...
         <div class="card hidden-sm">
             ...
             <div class="body">
                 ...
                 <div class="list-group mb-2">
                     <a href="<?php echo e(route('makeVouchers', app()->getLocale())); ?>"
                         class="list-group-item list-group-item-action <?php echo e(Route::is('makeVouchers') ? 'active' : ''); ?>"><?php echo e(__('Generate Vouchers')); ?></a>
                     <?php if(Auth::user()->is_ticket_admin): ?>
                         <a href="<?php echo e(url('ticketadmin/tickets')); ?>"
                             class="list-group-item list-group-item-action <?php echo e(Route::is('support') ? 'active' : ''); ?>"><?php echo e(__('Manage Tickets')); ?></a>
                     <?php endif; ?>
                     <?php if(Auth::user()->role_id == 1): ?>
                         <a href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/update_rates"
                             class="list-group-item list-group-item-action "><?php echo e(__('Update Exchange Rates')); ?></a>
                     <?php endif; ?>
                 </div>
                 <a href="<?php echo e(url('/')); ?>/admin/dashboard" class="btn btn-primary btn-round">Go to admin
                     dashboard</a>
     ...
     <?php if(Auth::user()->role_id == 3): ?>
         <div class="card hidden-sm">
             ...
             <div class="body ">
                 ...
                 <div class="list-group mb-2">
                     <a href="<?php echo e(route('makeVouchers', app()->getLocale())); ?>"
                         class="list-group-item list-group-item-action <?php echo e(Route::is('makeVouchers') ? 'active' : ''); ?>"><?php echo e(__('Recharge Vouchers')); ?></a>
                 </div>
             </div>
         </div>
     <?php endif; ?>
