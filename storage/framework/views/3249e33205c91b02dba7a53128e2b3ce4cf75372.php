...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?php echo e(asset('storage/imgs/fav-icon.png')); ?>" type="image/x-icon">
    ...
    <style type="text/css">
        ...
        <?php if (app()["auth"]->check() && app()["auth"]->user()->isImpersonated()): ?> .top_navbar {
            background: #fff;
        }
        ...
        <?php endif; ?> <?php echo $__env->yieldContent('styles'); ?>
    </style>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="body block-header">
                            <div class="row">
                                <div class="col">
                                    <h2 style="padding-top: 10px"><?php echo e(__('Welcome back')); ?> <?php echo e(Auth::user()->name); ?> !
                                    </h2>

                                </div>
                                <div class="text-right">
                                    <a href="<?php echo e(route('addFundsForm', app()->getLocale())); ?>" class="btn btn-primary btn-round bg-blue float-right  m-l-10"><?php echo e(__('Add
                                        Fund')); ?></a>
                                </div>
                                <div class="text-right">
                                    <a href="<?php echo e(route('show.currencies', app()->getLocale())); ?>" class="btn btn-primary btn-round bg-blue float-right  m-l-10"><?php echo e(__('Add
                                        Wallet')); ?></a>
                                </div>
                            </div>
                        </div>
