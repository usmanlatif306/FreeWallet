                    ...
                    <div class="preview col-lg-4 col-md-12">
                        <div class="preview-pic tab-content">
                            <div class="tab-pane active show" id="product_1">
                            	<img src="<?php echo e(url('/')); ?>/storage/imgs/smOMNQbvaoIgP8Y2TcA6DfgAdVdWsXe1Caww3aYV.png
" class="img-fluid">
                            </div>
                    ...
                    <div class="details col-lg-8 col-md-12" id="buy_form">
                        <h3 class="product-title m-b-0"><?php echo e(__('Add funds to your wallet with your Paystack')); ?></h3>                        
