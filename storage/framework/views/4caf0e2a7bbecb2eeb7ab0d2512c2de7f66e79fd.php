...
<body id="top">
        ...
        <section class="navigation">
            <header>
                <div class="header-content">
                    <div class="logo"><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(setting('site.welcome_page_logo_url')); ?>" width="20%" alt="infinio logo"></a></div>
    ...
    <script>
        window.jQuery || document.write('<script src="<?php echo e(asset('
