...
<head>
    ...
    <title>Identification - <?php echo e(setting('site.site_name')); ?></title>
    <!--  all css files  -->
    <link rel="stylesheet" href="<?php echo e(asset('face/css/bootstrap.min.css')); ?>">
...
<body>
    <div class="camera-holder position-relative" id="idscannerpage">
        ...
        <div id="camera" class="faceki-card faceki-card-light">
                ...
                <ul class="faceki-card__list">
                    <li class="faceki-card__item justify-content-center">
                        <div class="id-card-logo">
                            <img class="faceki-card__img" src="face/img/user-info/id-front-light.png" alt="">
                        </div>
            ...
            <div id="camera-screen-desktop">
                <img class="camera-screen-desktop d-none d-md-block" src="face/img/shape/desktop.png" alt="">
            </div>
            <div id="camera-screen-mobile">
                <img class="camera-screen-android d-md-none" src="face/img/shape/mobile.png" alt="">
            </div>
        ...
        <div class="camera-holder">
            <div class="faceki-card faceki-card-light mx-auto position-relative mx-auto">
                ...
                <div id="desktop-selfie" class="d-none d-md-block">
                    <img src="face/img/shape/selfie-desktop.png" alt="">
                </div>

                <div id="mobile-selfie">
                    <img class="slfie-screen d-md-none" src="face/img/shape/selfie.png" alt="">
                </div>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="71" viewBox="0 0 70 71">
                        <g id="Group_276" data-name="Group 276" transform="translate(1.032 1.4)">
                            <g id="Group_126" data-name="Group 126" transform="translate(0)">
                                <ellipse id="Oval_2" data-name="Oval 2" cx="34" cy="34.5" rx="34" ry="34.5"
                                    transform="translate(-0.032 -0.4)" fill="none" stroke="#fff" stroke-miterlimit="10"
                                    stroke-width="2" />
                                <circle id="Oval_2-2" data-name="Oval 2" cx="26" cy="26" r="26"
                                    transform="translate(7.968 8.6)" fill="#fff" />
                            </g>
                            <g id="Group_129" data-name="Group 129" transform="translate(22.77 22.428)">
                                <g id="Group_128" data-name="Group 128">
                                    <path id="Path_134" data-name="Path 134"
                                        d="M703.9,322.184l.947-1.891a4.743,4.743,0,0,1,.4-.617,2.143,2.143,0,0,1,.724-.65.987.987,0,0,1,.438-.107h6.528a.988.988,0,0,1,.44.107,2.145,2.145,0,0,1,.724.65,4.862,4.862,0,0,1,.412.632l.937,1.876h1.84a3.808,3.808,0,0,1,3.808,3.808v9.792a3.808,3.808,0,0,1-3.808,3.808H702.062a3.808,3.808,0,0,1-3.808-3.808v-9.792a3.808,3.808,0,0,1,3.808-3.808Zm-1.3,5.44a1.088,1.088,0,1,0-1.088-1.088,1.088,1.088,0,0,0,1.088,1.088Zm7.072,7.616a4.9,4.9,0,1,0-4.9-4.9,4.9,4.9,0,0,0,4.9,4.9Z"
                                        transform="translate(-698.254 -318.92)" fill="#464c5f" />
                                    <path id="Path_135" data-name="Path 135"
                                        d="M709.062,333.536a3.808,3.808,0,1,0-3.808-3.808,3.808,3.808,0,0,0,3.808,3.808Z"
                                        transform="translate(-697.638 -318.304)" fill="#464c5f" fill-rule="evenodd" />
                                </g>
                            </g>
                        </g>
                    </svg>
                ...
                <div class="facescane_my">
                    <img class="pattern d-md-none" src="face/img/shape/pattern.png" alt="">
    ...
    <section id="verifypage" style="display:none !important; height: 100vh;"
        class="faceki-section d-flex flex-wrap align-items-center justify-content-center w-100">
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-lg-6 col-xl-5 mx-auto">
                    <div class="faceki-card faceki-card-dark success__card">
                        ...
                        <img src="face/img/icon/Faceki-Verifing-animation2.gif" alt="Verifying...">
    ...
    <section id="successfullpage" style="display:none !important; height: 100vh;"
        class="faceki-section d-flex flex-wrap align-items-center justify-content-center w-100">
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-lg-6 col-xl-5 mx-auto">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="96" height="96" viewBox="0 0 96 96">
                                <g id="tick" transform="translate(2.5 2.5)">
                                    <path id="Path_64" data-name="Path 64"
                                        d="M45.5,0A45.5,45.5,0,1,1,0,45.5H0A45.37,45.37,0,0,1,45.241,0Z"
                                        transform="translate(0 0)" fill="none" stroke="#9ea0ae" stroke-width="5" />
                                    <path id="Path_65" data-name="Path 65"
                                        d="M132.437,111.207l-32.315,32.315-18.1-17.967,7.368-7.239,10.729,10.6,24.948-24.947Z"
                                        transform="translate(-61.731 -78.245)" fill="#9ea0ae" />
                                </g>
                            </svg>
                        </div>
                    ...
                    <form id="successfullForm" action="<?php echo e(route('identification_with_camera',app()->getLocale())); ?>"
                        method="post">
    ...
    <section id="extrapage" style="display:none !important; height: 100vh;"
        class="faceki-section d-flex flex-wrap align-items-center justify-content-center w-100">
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-lg-6 col-xl-5 mx-auto">
                    <div class="faceki-card faceki-card-dark success__card">
                        <div class="success__icon">
                            <img src="face/img/icon/tick.png" alt="">
                        </div>
    ...
    <script src="<?php echo e(asset('face/js/kyc.js')); ?>"></script>
                    ...
                    if (this.status == "200") {
                        if (resp.status) {
                            if (resp.status == 'Accepted') {
                                ...
                                setTimeout(function () {
                                    // window.location.href = baseUrl + e / identity / idscaner;
                                    document.getElementById('successfullForm').submit();
                                }, 1000);
