  ...
  <div class="col-md-9 " style="padding-right: 0" id="#sendMoney">
    ...
    <div class="card">
      ...
      <div class="body">
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('requestMoney', app()->getLocale())); ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col">
              <input type="submit" class="btn btn-primary float-right" value="<?php echo e(__('Request Money')); ?>" <?php echo e(auth()->user()->identified ? '' : 'disabled'); ?>>
            </div>
          </div>
          <div class="clearfix"></div>
        </form>
