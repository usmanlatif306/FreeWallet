        ...
        <div class="col-md-9 ">
          <div class="card">
            ...
            <div class="body">
              <div class="row">
                <div class="col">
                  <a href="<?php echo e(route('merchant.new')); ?>" class="btn btn-primary float-right mb-4"><?php echo e(__('Add Merchant')); ?></a>
                </div>
              </div>
                  ...
                  <tbody>
                    <?php $__currentLoopData = $merchants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $merchant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td><a href="<?php echo e(url('/')); ?>/merchant/<?php echo e($merchant->id); ?>/docs" class="btn btn-primary btn-sm"><?php echo e(__('Integration Guide')); ?></a></td>
                        </tr>
