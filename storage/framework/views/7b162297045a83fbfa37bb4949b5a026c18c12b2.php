            ...
            <div class="col-12">
                <div class="menu">
                    <ul class="list">
                        ...
                        <!-- <li class="<?php echo e((Route::is('receivedMoneyForm') ? 'active open' : '')); ?>">
                            <a href="<?php echo e(route('receivedMoneyForm',  app()->getLocale())); ?>"><i class="icon-arrow-left"></i><span><?php echo e(__('Received')); ?></span></a>
                        </li> -->
