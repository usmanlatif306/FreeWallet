    ...
    <div class="page-content edit-add container-fluid">
        <div class="row">
            <?php echo $__env->make('flash', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
             <?php if(isset($dataTypeContent->message)): ?>
            <div class="col-md-12">
                 <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    <div class="panel-body" style="padding-top:0;">
                        <?php echo e($dataTypeContent->message); ?>
             ...
             <?php endif; ?>
            <?php if(isset($dataTypeContent->transaction_receipt)): ?>
            <div class="col-md-12">
                 ...
                 <div class="panel panel-bordered" style="padding-bottom:5px;">
                    <div class="panel-heading">
                        <a href="<?php echo e(filter_var($dataTypeContent->transaction_receipt, FILTER_VALIDATE_URL) ? $dataTypeContent->transaction_receipt : Voyager::image( $dataTypeContent->transaction_receipt )); ?>" target="blank" class="btn btn-link">view in new tab</a>
                    </div>
                    <div class="panel-heading" style="border-bottom:0;">
                        <h3 class="panel-title">Transaction Receipt</h3>
                    </div>
                    <div class="panel-body" style="padding-top:0;">
                        <img src="<?php echo e(filter_var($dataTypeContent->transaction_receipt, FILTER_VALIDATE_URL) ? $dataTypeContent->transaction_receipt : Voyager::image( $dataTypeContent->transaction_receipt )); ?>" class="img-responsive" />
                        <div class="clearfix"></div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                            ...
                            action="<?php echo e(route('confirm.deposit', app()->getLocale())); ?>"
                        ...
                        <div class="panel-body">
                            ...
                            <?php $__currentLoopData = $dataTypeRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <?php if($options && isset($options->legend) && isset($options->legend->text)): ?>
                                    <legend class="text-<?php echo e(isset($options->legend->align) ? $options->legend->align : 'center'); ?>" style="background-color: <?php echo e(isset($options->legend->bgcolor) ? $options->legend->bgcolor : '#f0f0f0'); ?>;padding: 5px;"><?php echo e($options->legend->text); ?></legend>
                                <?php endif; ?>
