...
<body class="theme-green">
                ...
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12">
                        <div class="company_detail">
                            <h4 class="logo"><img src="<?php echo e(setting('site.logo_url')); ?>" alt="Logo"> <?php echo e(strtoupper(setting('site.site_name'))); ?></h4>
                            <h3><?php echo e(setting('site.site_name')); ?> <?php echo e(__('is the faster, safer way to pay in the internet')); ?>
                            ...
                            <form class="form" method="POST" action="<?php echo e(route('register', app()->getLocale())); ?>">
                                ...
                                <div class="input-group">
                                    <input type="text"
                                        ...
                                        value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('Enter User Name')); ?>" required
                                        autofocus>
                                ...
                                <div class="input-group">
                                    <input type="email"
                                        ...
                                        name="email" value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(__('Enter Email')); ?>"
                                        required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control z-index show-tick" placeholder="Select Your Contry"
                                        ...
                                        <option value="<?php echo e($country->code); ?>" data-prefix="<?php echo e($country->prefix); ?>">
                                ...
                                <div class="input-group">
                                    <input type="phone"
                                        ...
                                        name="phone" value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(__('Mobile Number')); ?>"
                                ...
                                <div class="input-group">
                                    <input id="password-confirm" type="password" class="form-control"
                                        name="password_confirmation" placeholder="<?php echo e(__('Repeat Password')); ?>" required>
                                    <span class="input-group-addon"><i class="zmdi zmdi-lock"></i></span>
                                ...
                                <div class="checkbox">
                                    ...
                                    <label for="terms"><?php echo e(__('I read and Agree to the')); ?> <a
                                            href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/page/3"><?php echo e(__('Terms of
                                            Usage')); ?></a></label>
                                ...
                                <div class="footer">
                                    <input type="submit" value="<?php echo e(__('SIGN UP')); ?>"
                                        class="btn btn-primary btn-round btn-block">
                                </div>
                            </form>
                            <a class="link" href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/login"><?php echo e(__('You already have a
                                membership?')); ?></a>
                        </div>
                    </div>
                </div>
    ...
    <!-- Jquery Core Js -->
    <script src="<?php echo e(asset('assets/js/libscripts.bundle.js')); ?>"></script>
