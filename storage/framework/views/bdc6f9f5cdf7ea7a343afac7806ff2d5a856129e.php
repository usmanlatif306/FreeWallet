            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <table class="table table-striped" style="margin-bottom: 0;">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo e($dataTypeContent->id); ?></td>
                                <td><?php echo e($dataTypeContent->created_at); ?><br> 
                                <td><?php echo e($dataTypeContent->gross); ?> $</td>
                                <td>- <?php echo e($dataTypeContent->fee); ?> $</td>
                                <td> <?php echo e($dataTypeContent->net); ?> $</td>
                                 <td> <?php echo e($dataTypeContent->send_to_platform_name); ?> </td>
                                <td> <?php echo e($dataTypeContent->platform_id); ?></td>
                            </tr>
                        </tbody>
                      </table>
                  </div>
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                            ...
                            action="<?php echo e(route('confirm.withdrawal', app()->getLocale())); ?>"
                        ...
                        <div class="panel-footer">
                            ...
                            <?php if($balance >= $dataTypeContent->gross): ?>
                                
                                
                                <?php if( $user->account_status == 1 and $dataTypeContent->transaction_state_id == 3): ?>
                                    <a href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/account_status/<?php echo e($user->id); ?>" class="btn btn-danger">Pause Account Activities</a>
                                <?php else: ?>
