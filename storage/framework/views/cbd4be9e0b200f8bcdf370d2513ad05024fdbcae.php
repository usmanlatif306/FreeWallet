                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown profile">
                        ...
                        <ul class="dropdown-menu pullDown">
                            ...
                            <li>
                                <a href="<?php echo e(url(app()->getLocale().'/')); ?>/blog"><i class="icon-directions m-r-10"></i><span><?php echo e(__('Tutorials')); ?></span></a>
                            </li>
                            <li><a href="<?php echo e(url(app()->getLocale().'/')); ?>/my_tickets"><i class="icon-lock m-r-10"></i><span><?php echo e(__('Support')); ?></span></a></li>
                            <?php if (app()["auth"]->check() && app()["auth"]->user()->isImpersonated()): ?>
                            <li>
                            ...
                            <li><a href="<?php echo e(route('logout', app()->getLocale())); ?>" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="icon-power m-r-10"></i><span> <?php echo e(__('Logout')); ?></span></a>
