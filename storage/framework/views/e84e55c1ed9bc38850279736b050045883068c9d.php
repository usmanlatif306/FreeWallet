...
<?php $__env->startSection('page_header'); ?>
    <h1 class="page-title">
        ...
        <a href="<?php echo e(route('wallet.transaction.edit', $dataTypeContent->getKey())); ?>" class="btn btn-info">
        ...
        <a href="<?php echo e(route('wallet.transaction.index')); ?>" class="btn btn-warning">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?php echo e(route('wallet.transaction.destroy',$dataType->id)); ?>" id="delete_form" method="POST">
