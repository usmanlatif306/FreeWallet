        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h4>Regular User</h4>                    
                    <div class="demo-img"><a href="<?php echo e(route('demouser')); ?>"><img alt="" src="<?php echo e(asset('assets/images/thumb1.jpg')); ?>" class="img-responsive"></a></div>
                    <div class="demo-links">
                        <a href="<?php echo e(route('demouser')); ?>" target="_blank" class="btn btn-fill btn-large btn-margin-right">Demo</a>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h4>Admin User</h4>                    
                    <div class="demo-img"><a href="https://admin.bitmetical.com/demo/admin"><img alt=""  src="<?php echo e(asset('assets/images/thumb2.jpg')); ?>" class="img-responsive"></a></div>
                    <div class="demo-links">
