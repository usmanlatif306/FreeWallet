                    ...
                    <div class="header-nav">
                        <nav>
                            ...
                            <ul class="member-actions">
                                    <?php if(Auth::check()): ?>
                                        <li><a href="<?php echo e(route('logout')); ?>" class="login" onclick="event.preventDefault();
                                     ...
                                     <?php if(Auth::user()->role_id == 1): ?>
                                             <li><a href="<?php echo e(url('/admin')); ?> " class="login"><?php echo e(('Admin')); ?></a></li>
                                        <?php endif; ?>
                                        <li><a href="<?php echo e(url('/home')); ?> " class="btn-white btn-small"><?php echo e(('My')); ?> <?php echo e(setting('site.site_name')); ?></a></li>

                                    <?php else: ?>
                                        <li><a href="<?php echo e(url('/register')); ?>" class="login"><?php echo e(__('Register')); ?></a></li>
                                        <li><a href="<?php echo e(url('/login')); ?>" class="btn-white btn-small"><?php echo e(__('Log in')); ?></a></li>
                                    <?php endif; ?>
                            </ul>
                            <?php endif; ?>
                        </nav>
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="hero-content text-center">
                        ...
                        <p class="intro">Pay in a snap with the easy and elegant interface which gives you an outstanding experience.<br>
                            ...
                            <?php if(Auth::check()): ?>
                                <a href="<?php echo e(url('/')); ?>/home" class="btn btn-fill btn-large btn-margin-right">dashboard</a>
                            <?php else: ?>
                               <a href="<?php echo e(url('/')); ?>/login" class="btn btn-large btn-margin-right">Get Started</a>
                            <?php endif; ?>
