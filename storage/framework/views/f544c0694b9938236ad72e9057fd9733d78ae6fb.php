                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="<?php echo e((Route::is('sendMoneyForm') ? 'active open' : '')); ?>"> 
                            <a href="<?php echo e(route('sendMoneyForm', app()->getLocale())); ?>"><i class="icon-arrow-right"></i><span><?php echo e(__('Send Money')); ?></span></a>
                        </li>
                        <li class="<?php echo e((Route::is('requestMoneyForm') ? 'active open' : '')); ?>"> 
                            <a href="<?php echo e(route('requestMoneyForm',  app()->getLocale())); ?>"><i class="icon-arrow-left"></i><span><?php echo e(__('Request Money')); ?></span></a>
                        </li>
