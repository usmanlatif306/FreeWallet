    ...
    <div class="row">
        ...
        <div class="col-md-9 " >
            <div class="card">
                ...
                <div class="body">
                     <form action="<?php echo e(route('merchant.add', app()->getLocale())); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                          <div class="form-group <?php echo e($errors->has('merchant_ipn_link') ? ' has-error' : ''); ?>">
                            <label for="merchant_ipn_link"><?php echo e(__('Instant Payment Notification (IPN) Url')); ?></label>
                            <input type="text" class="form-control" id="merchant_ipn_link" name="merchant_ipn_link" value="<?php echo e(old('merchant_ipn_link')); ?>" required>
                            <?php if($errors->has('merchant_ipn_link')): ?>
                                <span class="help-block">
                                    <strong><?php echo e($errors->first('merchant_ipn_link')); ?></strong>
                                </span>
                            <?php endif; ?>
                          </div>
                        </div>
