                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <ul class="breadcrumb p-l-0 p-b-0 ">
                                    <li class="breadcrumb-item"><a href="<?php echo e(url(app()->getLocale().'/')); ?>"><i class="icon-home"></i></a></li>
                                    <li class="breadcrumb-item ">
                                        <span class="text-primary"><?php echo e(Auth::user()->currentCurrency()->code); ?> (<?php echo e(Auth::user()->currentCurrency()->symbol); ?>)</span>
                                    </li>
                                    <li class="breadcrumb-item ">
                                        <span class="text-primary"><?php echo e(Auth::user()->currentWallet()->TransferMethod->name); ?> </span>
                                    </li>
                                    <li class="breadcrumb-item ">
                                        <span class=""><strong><?php echo e(Auth::user()->currentWallet()->accont_identifier_mechanism_value); ?> </strong></span>
                                    </li>
                                </ul>
                            </div>            
                            <div class="col text-right">
                               <a href="<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/deposit/<?php echo e(Auth::user()->currentWallet()->id); ?>" class="btn btn-primary btn-round  float-right  m-l-10"><?php echo e(__('Add Funds')); ?></a>
                                <a href="<?php echo e(route('show.transfermethods', app()->getLocale())); ?>" class="btn btn-primary btn-round bg-blue float-right  m-l-10"><?php echo e(__('Add Wallet')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
