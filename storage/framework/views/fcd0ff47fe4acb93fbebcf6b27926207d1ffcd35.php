	   	...
	   	<div class="card">
		    ...
		    <div class="body">
               <p><span class="text-primary">Merchant Key : </span><?php echo e($merchant->merchant_key); ?> </p>
			   	...
			   	<p><span class="text-primary">Merchant Request URL : </span><?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/purchase/link</p>
			   	<p><span class="text-primary">Merchant Transaction Status URL : </span><?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/request/status</p>
    ...
    <div class="body">
		...
		<h5><strong>Step 1:</strong></h5>
	   	<div class="alert alert-info mb-5">
	   		<p>Send a CURL POST request that contains <strong><small>(string) => </small>'merchant_key'</strong>, <strong><small>(array) => </small>'invoice'</strong>, and <strong><small>(string) => </small> 'currency_code'</strong> variables to  <kbd><?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/purchase/link</kbd>. As a response you get an array containing the link to the checkout page
	   		</p>
...
$invoice['total'] = 40.00;
$invoice['return_url'] = '<?php echo e($merchant->success_link); ?>';
$invoice['cancel_url'] = '<?php echo e($merchant->fail_link); ?>';
...
<pre class="mb-0 bg-dark text-white  p-5 br-2">
    $post = array(
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, '<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/purchase/link' );
...
<pre class="mb-0 bg-dark text-white  p-5 br-2">
        ...
        if (isset($_GET['token']) and !is_null($_GET['token'])) {
            ...
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, '<?php echo e(url('/')); ?>/<?php echo e(app()->getLocale()); ?>/request/status' );
            curl_setopt($ch, CURLOPT_POST, true);
            curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
            curl_setopt($ch, CURLOPT_POSTFIELDS, $post);
